...
arr_events = [
              ...
              { name: 'Walk the Bund', start: DateTime.parse('2019-12-08 13:00:00'), end: DateTime.parse('2019-12-08 15:00:00'), description: 'I would like to take a walk with someone and see the skyline of Shanghai', image: 'http://lc-dnc55p3h.cn-e1.lcfile.com/e6cbf6aecd27b29ae97d', slots: 2, tag_list: 'walk' },
              { name: 'Ultimate Frisbee', start: DateTime.parse('2019-12-08 14:00:00'), end: DateTime.parse('2019-12-08 17:00:00'), description: 'Play some ultimate! Get some exercise! Make some friends!', image: 'http://lc-dnc55p3h.cn-e1.lcfile.com/a2f10603fad8429f5205', slots: 30, tag_list: 'ultimate' },
              ...
              { name: 'Ballers night', start: DateTime.parse('2019-12-10 18:00:00'), end: DateTime.parse('2019-12-10 20:00:00'), description: 'We are a group of people who like to shoot b-ball outside the school', image: 'http://lc-dnc55p3h.cn-e1.lcfile.com/43b6bad7e8633f465079', slots: 10, tag_list: 'basketball'},
              { name: 'Cycle Shanghai', start: DateTime.parse('2019-12-07 08:00:00'), end: DateTime.parse('2019-12-07 14:00:00'), description: 'We need an experienced rider who can fill in for an injury on our team.', image: 'http://lc-dnc55p3h.cn-e1.lcfile.com/e8ffaea1e33a475ef343', slots: 2, tag_list: 'cycling' },
