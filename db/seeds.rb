...
arr_events = [
              { name: 'Yoga Time', start: DateTime.parse('2019-12-08 15:00:00'), end: DateTime.parse('2019-12-08 16:00:00'), description: 'Come stretch with us.', image: 'http://lc-dnc55p3h.cn-e1.lcfile.com/4545b589def4381b78a9', slots: 5, tag_list: 'yoga' },
              { name: 'Football fun', start: DateTime.parse('2019-12-08 10:30:00'), end: DateTime.parse('2019-12-08 16:00:00'), description: 'I am organizing a kick-around with some friends and could always use some more players', image: 'http://lc-dnc55p3h.cn-e1.lcfile.com/c32ac674db34f5b4eec2', slots: 20, tag_list: 'soccer' },
              { name: 'Walk the Bund', start: DateTime.parse('2019-12-08 13:00:00'), end: DateTime.parse('2019-12-08 15:00:00'), description: 'I would like to take a walk with someone and see the skyline of Shanghai', image: 'http://lc-dnC55P3H.cn-e1.lcfile.com/fa90b44201d14beceab4/1-Shanghai-The-Bund.jpg', slots: 2, tag_list: 'walk' },
              { name: 'Ultimate Frisbee', start: DateTime.parse('2019-12-08 14:00:00'), end: DateTime.parse('2019-12-08 17:00:00'), description: 'Play some ultimate! Get some exercise! Make some friends!', image: 'http://lc-dnC55P3H.cn-e1.lcfile.com/a081dd7e34d85b0d62ab/online-frisbeehudson-10.jpg', slots: 30, tag_list: 'ultimate' },
              ...
              { name: 'Rugby Bonanza', start: DateTime.parse('2019-12-08 10:00:00'), end: DateTime.parse('2019-12-08 16:00:00'), description: 'We are setting up a for fun tournament, we will sort you into teams by skill level. All levels welcome', image: 'http://lc-dnc55p3h.cn-e1.lcfile.com/431b5191ba2da9fb942b', slots: 60, tag_list: ['rugby', 'tournament'] },
              { name: 'Ballers night', start: DateTime.parse('2019-12-10 18:00:00'), end: DateTime.parse('2019-12-10 20:00:00'), description: 'We are a group of people who like to shoot b-ball outside the school', image: 'http://lc-dnC55P3H.cn-e1.lcfile.com/cbab403997f63b71cd02/vollyball.jpg', slots: 10, tag_list: 'basketball'},
              { name: 'Cycle Shanghai', start: DateTime.parse('2019-12-07 08:00:00'), end: DateTime.parse('2019-12-07 14:00:00'), description: 'We need an experienced rider who can fill in for an injury on our team.', image: 'http://lc-dnC55P3H.cn-e1.lcfile.com/870469772861864b39c0/cycle.jpeg', slots: 2, tag_list: 'cycling' },
              { name: 'Dancing is love', start: DateTime.parse('2019-12-09 20:00:00'), end: DateTime.parse('2019-12-09 22:00:00'), description: 'Swing dancing fun. All levels welcome', image: 'http://lc-dnC55P3H.cn-e1.lcfile.com/71b41a6e4040cceddbda', slots: 30, tag_list: ['swing', 'dancing'] }
             ]
