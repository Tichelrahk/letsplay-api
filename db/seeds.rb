...
arr_events = [{ name: 'Ballers night', start: DateTime.parse('2019-12-10 18:00:00'), end: DateTime.parse('2019-12-10 20:00:00'), description: 'We are a group of people who play b-ball outside the school', image: 'https://images.unsplash.com/photo-1531399597742-fbf70c342ece?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80' },
